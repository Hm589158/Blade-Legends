...
/* =========================================================================
   PROMO CODES — redeemable once each (case-insensitive). Edit freely.
   ========================================================================= */
const PROMO_CODES = {
  'BLADE':    { gold:300, gems:5,             msg:'هدية ترحيبية!' },
  'GEMS50':   { gems:50,                       msg:'٥٠ جوهرة!' },
  'STARTER':  { gold:600, iron:12, crystal:3,  msg:'حزمة البداية!' },
  'LEGEND':   { gems:120, gold:1500,           msg:'حزمة الأسطورة!' },
  'NASL2026': { gems:30, gold:500, essence:2,  msg:'كود أساطير النصل!' },
  /* developer mode: maxes every resource, can be re-used for testing */
  'DM':       { gold:999999, gems:999999, iron:999999, crystal:999999, essence:999999, repeatable:true, msg:'وضع المطوّر مُفعّل!' },
};

/* =========================================================================
   DUNGEON 2.0 — difficulty tiers + combat affixes
   ========================================================================= */
const DIFFICULTIES = [
  { id:0, key:'normal',    nameAr:'عادي',   statMul:1.00, rewardMul:1.00, affixes:[] },
  { id:1, key:'hard',      nameAr:'صعب',    statMul:1.75, rewardMul:1.65, affixes:['rage'] },
  { id:2, key:'nightmare', nameAr:'كابوس',  statMul:2.90, rewardMul:2.70, affixes:['rage','fragile'] },
];
const AFFIXES = {
  rage:    { nameAr:'الغضب',   icon:'😤', desc:'هجوم الأعداء +25%' },
  fragile: { nameAr:'الهشاشة', icon:'💔', desc:'فريقك يتلقّى ضرراً +15%' },
};
// minion name pools (the boss keeps the dungeon's named enemy)
const MINION_NAMES = {
  'نار':['شرارة هائجة','تابع اللهب','جمرة حيّة'],
  'ماء':['رذاذ متجمّد','تابع الجليد','موجة غاضبة'],
  'أرض':['غول صغير','حارس صخري','تابع الكهف'],
  'هواء':['نسيم حادّ','تابع العاصفة','زوبعة'],
  'روح':['طيف تائه','تابع شبحي','همسة باردة'],
};
